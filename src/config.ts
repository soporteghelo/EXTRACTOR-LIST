...
export const GEMINI_MODELS = [
  "gemini-3-flash-preview", // Our primary fast and robust model
  "gemini-3.1-pro-preview", // Fallback to advanced reasoning if flash fails
  "gemini-3.1-flash-lite-preview", // Final fallback
];
